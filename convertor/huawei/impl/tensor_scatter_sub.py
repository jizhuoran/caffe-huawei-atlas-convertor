...
def tensor_scatter_sub(x,
                       indices,
                       updates,
                       y,
                       kernel_name="tensor_scatter_sub"):
    """
    ...
    y: dict
        data of output.
    kernel_name: str
        kernel name, default value is "tensor_scatter_sub"

    Returns:
    None
    """
    tensor_scatter = TensorScatter(x, indices, updates, y, kernel_name, "vsub")
