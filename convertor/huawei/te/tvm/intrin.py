...
def relu(x):
    ...
    y : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "relu", x)
...
def lrelu(x, scalar):
    ...
    res : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "lrelu", x, scalar)
...
def vdeq_cast(x, y, dtype, do_relu=False):
    ...
    res : Expr
        The result.
    """
    return call_pure_intrin(dtype, "vdeq_cast", x, y, do_relu)
...
def conv_vdeq(x, y):
    ...
    res : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "conv_vdeq", x, y)
...
def deq_cast(x, y, dtype):
    ...
    res : Expr
        The result.
    """
    return call_pure_intrin(dtype, "deq_cast", x, y)
...
def rec(x):
    ...
    y : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "rec", x)

def rsqrt(x):
    """Take rsqrt of input x.
...
def maddrelu(x, y, z):
    ...
    res : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "maddrelu", x, y, z)
...
def muladd(x, y, z, dtype):
    """Take muladd of input x, y, z.
     ...
     res : Expr
         The result.
    """
    return call_pure_intrin(dtype, "muladd", x, y, z)
...
def unzip(x, y):
    """Unzip y according to index table x.
     ...
     res : Expr
         The unzipped data.
    """
    return call_pure_intrin(y.dtype, "unzip", x, y)
...
def mod(x, y):
    ...
    y : Expr
        The result.
    """
    return call_pure_intrin(x.dtype, "mod", x, y)
