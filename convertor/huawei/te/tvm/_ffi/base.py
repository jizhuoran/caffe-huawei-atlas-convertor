...
def call_tik_exception(py_err_msg):
    ...
    if _api_internal._GetCurrentBuildConfig().ir_location_enable:
        cce_intrin_md.tik_exception_process(_api_internal._GetCurrentLoc(), py_err_msg)
...
def get_last_ffi_error():
    ...
    if err_type == "TVMError":
        call_tik_exception(py_err_msg)
