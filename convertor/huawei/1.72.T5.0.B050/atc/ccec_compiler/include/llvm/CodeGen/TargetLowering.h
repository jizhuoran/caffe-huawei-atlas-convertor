...
public:
  ...
  /// Sometimes the simplification may lead to low performance.
  /// This function allow target to check if it is ok.
  virtual bool isSimplificationValid(const SDValue Old,
                                     const SDValue New) const {
    return true;
  }
