...
#include "llvm/Support/AutoTuning.h"
#include <algorithm>
#include <utility>
...
class Loop : public LoopBase<BasicBlock, Loop>,
             public autotuning::AutoTuningEnabledContainer {
public:
  ...
  /// Gets the induction variable of a loop
  /// This version relaxes the constraint of having the loop to start from 0.
  /// The loop lower bound can be an arbitrary expression.
  /// We enforce this lower bound to be invariant to the loop itself via SE
  /// analysis
  ///
  PHINode *getInductionVariable(Value *lowerBound, Value *upperBound) const;
