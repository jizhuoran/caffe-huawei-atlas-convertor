...
public:
  ...
  // Certain targets may want to peel the loop in the unroll pass without
  // unrolling the actual loop
  bool hasUnrollPeelPriority() const;
  ...
  struct UnrollingPreferences {
    ...
    unsigned PeelCount;
    /// Peeling factor from last iteration backwards
    unsigned PeelLastCount;
...
public:
  ...
  virtual bool hasUnrollPeelPriority() = 0;
...
public:
  ...
  bool hasUnrollPeelPriority() override { return Impl.hasUnrollPeelPriority(); }
