...
enum {
  ...
  // Now we have not applied for an official value for HiIPU, so use a large
  // number for it temporarily.
  EM_HIIPU = 0x1029, // HiIPU
};
...
// ELF Relocation types for HiIPU
enum {
#include "ELFRelocs/HiIPU.def"
};
