...
public:
  ...
  /// Tests whether the target is HiIPU (64-bit).
  bool isHiIPU() const {
    return getArch() == Triple::hiipu64;
  }

  /// Tests whether the target is AICpu (64-bit).
  bool isAICpu() const {
    return getArch() == Triple::aarch64 && getOS() == llvm::Triple::CCE;
  }
