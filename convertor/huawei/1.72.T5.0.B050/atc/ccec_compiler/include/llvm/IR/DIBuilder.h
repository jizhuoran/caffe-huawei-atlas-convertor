...
namespace llvm {
  ...
  public:
    ...
    createPointerType(DIType *PointeeTy, uint64_t SizeInBits,
                      ...
                      StringRef Name = "", unsigned AttrType = 0);
    ...
    /// \param Ty           Parent type.
    DIDerivedType *
    createVariantMemberType(DIScope *Scope, StringRef Name, DIFile *File,
                            unsigned LineNo, uint64_t SizeInBits,
                            uint32_t AlignInBits, uint64_t OffsetInBits,
                            Constant *Discriminant, DINode::DIFlags Flags,
                            DIType *Ty, unsigned AttrType = 0);
    ...
    createAutoVariable(DIScope *Scope, StringRef Name, DIFile *File,
                       ...
                       DINode::DIFlags Flags = DINode::FlagZero,
                       uint32_t AlignInBits = 0, unsigned AttrType = 0);
    ...
    /// If \c AlwaysPreserve, this variable will be referenced from its
    /// containing subprogram, and will survive some optimizations.
    DILocalVariable *createParameterVariable(
        DIScope *Scope, StringRef Name, unsigned ArgNo, DIFile *File,
        unsigned LineNo, DIType *Ty, bool AlwaysPreserve = false,
        DINode::DIFlags Flags = DINode::FlagZero, unsigned AttrType = 0);
    ...
    createFunction(DIScope *Scope, StringRef Name, StringRef LinkageName,
                   ...
                   DITypeArray ThrownTypes = nullptr, unsigned FuncType = 0);
