...
#undef GET_INTRINSIC_ENUM_VALUES
  ...
  /// Return the LLVM name for an intrinsic, such as "llvm.ppc.altivec.lvx".
  /// This version of getName does not care about overloading. Just return
  /// the pure intrinsic name without any name mangling. Therefore, don't
  /// need to assert even for overloaded function.
  /// Warning: only call this API when you don't care about overloading.
  StringRef getNonMangledName(ID id);
