...
_SOLVERPARAMETER_SOLVERMODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AICORE', index=2, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GENERATOR', index=3, number=3,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_AICOREKEREL = _descriptor.Descriptor(
  name='AicoreKerel',
  full_name='caffe.AicoreKerel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='kernelfile', full_name='caffe.AicoreKerel.kernelfile', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='kernelname', full_name='caffe.AicoreKerel.kernelname', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='block_num', full_name='caffe.AicoreKerel.block_num', index=2,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='aicorekernel', full_name='caffe.LayerParameter.aicorekernel', index=4,
...
_LAYERPARAMETER.fields_by_name['aicorekernel'].message_type = _AICOREKEREL
...
DESCRIPTOR.message_types_by_name['AicoreKerel'] = _AICOREKEREL
...
AicoreKerel = _reflection.GeneratedProtocolMessageType('AicoreKerel', (_message.Message,), dict(
  DESCRIPTOR = _AICOREKEREL,
  __module__ = 'caffe.proto.caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.AicoreKerel)
  ))
_sym_db.RegisterMessage(AicoreKerel)
